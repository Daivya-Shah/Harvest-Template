...
export default function About() {
    return (
        ...
        <section className="about-one" style={{ paddingBottom: '75px'}}>
                    ...
                    <div className="col-xl-7">
                        <div className="about-one__content">
                            <div className="sec-title tg-heading-subheading animation-style2">
                                <h2 className="sec-title__title tg-element-title">Sourcing<br/>
                                </h2>
                            </div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-xl-7">
                        <div className="about-one__content">
                            <div className="sec-title tg-heading-subheading animation-style2">
                                <h2 className="sec-title__title tg-element-title">Manufacturing<br/>
                                </h2>
                            </div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-xl-7">
                        <div className="about-one__content">
                            <div className="sec-title tg-heading-subheading animation-style2">
                                <h2 className="sec-title__title tg-element-title">Logistics<br/>
                                </h2>
                            </div>
